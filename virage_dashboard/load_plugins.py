...
def load_plugins(hass, name):
 #   add_extra_js_url(hass, "/dwains_dashboard/js/dwains-dashboard.js")
    ...
    #Cards by others
    #add_extra_js_url(hass, "/virage_dashboard/cards/button-card/button-card.js")
    #add_extra_js_url(hass, "/virage_dashboard/cards/light-entity-card/light-entity-card.js")

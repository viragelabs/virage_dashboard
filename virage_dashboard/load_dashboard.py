...
def load_dashboard(hass, config_entry):
    ...
    sidepanel_title = "Virage Dashboard"
    sidepanel_icon = "mdi:alpha-v-circle"
    dashboard_url = "virage-dashboard"
    dashboard_config = {
        "mode": "yaml",
        "icon": sidepanel_icon,
        "title": sidepanel_title,
        "filename": "custom_components/virage_dashboard/lovelace/ui-lovelace.yaml",
